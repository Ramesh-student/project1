...
import { Zap, LogOut, User, CheckCircle, Clock, MapPin, Calendar, CreditCard, Smartphone, Copy } from "lucide-react"
...
export default function ElectricianDashboard() {
  ...
  const checkUser = async () => {
    try {
      ...
      if (profile?.user_type !== "provider" || profile?.service_type !== "electrician") {
        router.push("/auth/login")
        return
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900">ServiceHub - Electrician</h1>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <User className="h-5 w-5 text-gray-500" />
                <span className="text-gray-700">{user?.full_name || "Demo Electrician"}</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Electrician Dashboard</h2>
          <p className="text-gray-600">Manage your electrical service requests</p>
        </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Electrical Service Requests</CardTitle>
                  ...
                  <div key={request.id} className="border rounded-lg p-6 bg-white">
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-lg">Electrical Service Request</h3>
